...
// Q27
"Q. Which of the STL containers store the elements contiguously\n(in adjacent memory locations)?",
...
"Q. Function templates can accept : " };
	...
	{"A) Checking memory leaks after exitting the program","B) Informing Operating System that program has terminated","C) Running a function at exitting the program","D) No such preprocessor exist"},//8
	...
	{"A) std::vector","B) std::list","C) std::map","D) std::set"},//27
	...
	{"A) Structured Programming","B) Object Oriented Programming (OOP)","C) Functional Programming","D) Aspect Oriented Programming (AOP)"},//37
	...
	public void login(){
		...
		Image image = ImageIO.read(url);*/
    		//JLabel img1 = new JLabel(new ImageIcon(image));
		...
		//background image
		img=new JLabel(new ImageIcon("//home/comp-hl-29/Desktop/TechWizard/back2.jpg"));
		img.setSize(100,100);
		img.setBounds(0,0,1366,768);
		f_login.add(img);
		img.setLayout(new FlowLayout());
	...
	public boolean connect(String Name,String Phone){
		...
		try{  
			...
			con=DriverManager.getConnection("jdbc:mysql://172.16.0.101:3306/TechMania","root","root");   
			st=con.createStatement();  
			rs=st.executeQuery("select * from login where phone='"+Phone+"'");
	...
	public void StartPage(){
		...
		f_start.setContentPane(img);
	    	...
	    	instruction.setBounds(100,20,100,100);
        	instruction.setBackground(Color.white);  
	    	f_start.setContentPane(instruction);
	...
	public void McqTest(){
		...
		/*try{
    		URL url = new URL("http://www.widehdimages.com/download/black-abstract-wallpaper-37-1366x768/");
		Image image = ImageIO.read(url);*/
		
		//background image
		img=new JLabel(new ImageIcon("/home/root1/Desktop/TechWizard/back3.jpg"));
		img.setSize(100,100);
		img.setBounds(0,0,1366,768);
		f_mcq.add(img);
		img.setLayout(new FlowLayout());
	...
	public void final_score(){
		...
		//Background image
		img=new JLabel(new ImageIcon("//home/comp-hl-29/Desktop/TechWizard/back3.jpg"));
		img.setSize(100,100);
		img.setBounds(0,0,1366,768);
		f_final.add(img);
		img.setLayout(new FlowLayout());
		...
		try{  
			...
			con=DriverManager.getConnection("jdbc:mysql://172.16.0.101:3306/TechMania","root","root");   
			st=con.createStatement();  
			dummy=st.executeUpdate("update login set marks='"+count+"' where phone='"+Number+"'");
